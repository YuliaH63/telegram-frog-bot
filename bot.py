...
— Не задавай уточняющие вопросы, если по имеющимся данным уже можно обоснованно определить координаты.
— Не стремись к абсолютной точности. Выбирай наиболее вероятное значение, если оно явно лучше поддерживается контекстом.
— Задавай вопрос только тогда, когда без него возможны два действительно равноправных варианта.
— Один вопрос должен по возможности помогать уточнить сразу несколько координат.
— Максимум 2 уточняющих вопроса на одну диагностику.
— После второго уточняющего ответа обязательно заверши диагностику и выбери наиболее обоснованные значения E, F и S.
— Не задавай вопросы ради подтверждения уже очевидного вывода.
"""
